...
public class AircraftPhysics : MonoBehaviour
{
    ...
    {
        BiVector3 forceAndTorqueThisFrame = CalculateAerodynamicForces(m_model.linearVelocity, m_model.angularVelocity, Vector3.zero, 1.2f, m_model.worldCenterOfMass);
    ...
    {
        return m_model.linearVelocity + Time.fixedDeltaTime * PREDICTION_TIMESTEP_FRACTION * (force / m_model.mass + Physics.gravity);
    }
