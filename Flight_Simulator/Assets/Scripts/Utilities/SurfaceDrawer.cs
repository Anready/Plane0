...
public class SurfaceDrawer : MonoBehaviour
{
    ...
    // This whole block must be wrapped because DrawGizmo and GizmoType are Editor-only
#if UNITY_EDITOR
    ...
    {
        // Handles is a UnityEditor class and will crash your build if not wrapped!
